...
import { ZoomInOutlined, ZoomOutOutlined, UndoOutlined, RedoOutlined, DownloadOutlined } from '@ant-design/icons';
...
export default forwardRef<ImagePreviewRef, { imgSrc: string; imgName?: string; maskClosable?: boolean }>(
  ({ imgSrc, imgName = 'preview', maskClosable = true }, ref) => {
    ...
    return (
      <div className={styles.previewBox} style={{ display: visible ? 'flex' : 'none' }}>
